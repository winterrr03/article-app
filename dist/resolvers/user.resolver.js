...
exports.resolversUser = {
    Query: {
        getUser: function (_, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var tokenVerify, infoUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tokenVerify = context.req.tokenVerify;
    ...
    Mutation: {
        registerUser: function (_, args) { return __awaiter(void 0, void 0, void 0, function () {
            var user, existUser, newUser, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = args.user;
